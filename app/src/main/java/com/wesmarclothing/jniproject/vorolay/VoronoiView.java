package com.wesmarclothing.jniproject.vorolay;
...
public class VoronoiView extends ViewGroup {
    ...
    private void init(AttributeSet attrs) {
        ...
        mBorderEnabled = a.getBoolean(R.styleable.VoronoiView_voronoi_show_border, DEF_BORDERS);
        mBorderColor = a.getColor(R.styleable.VoronoiView_voronoi_border_color, DEF_BORDERS_COLOR);
        mBorderWidth = a.getFloat(R.styleable.VoronoiView_voronoi_border_width, DEF_BORDER_WIDTH);
        mRoundCornersEnabled = a.getBoolean(R.styleable.VoronoiView_voronoi_border_round, DEF_BORDER_CORNERS_ROUND);
        mGenerationType = a.getInt(R.styleable.VoronoiView_voronoi_generation_type, DEF_GENERATION_TYPE);
        a.recycle();
    ...
    protected boolean drawChild(Canvas canvas, View child, long drawingTime) {
        ...
        canvas.clipPath(region.path, Region.Op.DIFFERENCE);

//        region.path.op(region.path, Path.Op.XOR);
